/
 (c) Michael Guyver, 2012 
 Free for educational, non-commercial use only. This software is provided as-is and without warranty
 as to its fitness for purpose or otherwise. 
\
...
/ canned script 4
.pmc.script4:{[domain]
	.pmc.runscript[`UopsAny`MemUopsLd`MemUopsSv`L3Miss;domain]
 };
system "c 45 191";
